...
#       dialign_dirs = create_dialign_directories(models_list, output_dir_name="dialign_normalized", to_local_directory=True, dataset=dataset, model_type=model_type, speakers=speakers)
#       print(dialign_dirs)