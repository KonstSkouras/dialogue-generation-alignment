...
#### Model Configuration
From Nathan Cooper's [Tutorial](https://nathancooper.io/i-am-a-nerd/chatbot/deep-learning/gpt2/2020/05/12/chatbot-part-1.html).
"""
...
# Changged evaluate_during_training to True
class Args():
  def __init__(self):
...
# def test(args, model: PreTrainedModel, tokenizer: PreTrainedTokenizer, df_tst, prefix="") -> Dict:
#   # Loop to handle MNLI double evaluation (matched, mis-matched)
#   test_output_dir = args.output_dir

#   test_dataset = load_and_cache_examples(args, tokenizer, df_tst, df_tst)
...
#     test_dataset, sampler=test_sampler, batch_size=1, collate_fn=collate, drop_last = True
#   )
...
#     # print("Batch:", batch)
#     conv = batch[0]
#     bot_input_ids_list = conv.tolist()
#     new_bot_input_ids_tsr = torch.tensor([bot_input_ids_list], dtype=torch.long)

#     # print("new_bot_input_ids_tsr", new_bot_input_ids_tsr)
#     # print("new_bot_input_ids_tsr type:", type(new_bot_input_ids_tsr))

#     chat_history_ids = model.generate(
#         new_bot_input_ids_tsr, max_length=200,
...
#     history_chat = tokenizer.decode(new_bot_input_ids[0], skip_special_tokens=False)
#     print("History: {}".format(history_chat.split('<|endoftext|>')))
#     # pretty print last ouput tokens from bot
#     print("Model: {}".format(tokenizer.decode(chat_history_ids[:, new_bot_input_ids.shape[-1]:][0], skip_special_tokens=True)))
...
#   # output_test_file = os.path.join(test_output_dir, prefix, "test_results.txt")
#   # with open(output_eval_file, "w") as writer:
